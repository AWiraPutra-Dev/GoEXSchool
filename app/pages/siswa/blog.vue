...
<template>
  <div class="space-y-4">
    <div>
      ...
      <p class="text-[13px]" style="color: var(--text-secondary);">Artikel dan informasi terbaru seputar ekstrakurikuler</p>
    </div>
    ...
    <div class="article-grid">
      <NuxtLink v-for="article in filteredArticles" :key="article.id" :to="`/siswa/blog/${article.slug}`" class="article-card">
        ...
        <div class="article-body">
          ...
          <p class="article-excerpt">{{ article.excerpt || article.content?.slice(0, 120) + '...' }}</p>
