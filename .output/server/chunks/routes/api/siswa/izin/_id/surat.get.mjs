import { c as defineEventHandler, g as getRouterParam, p as prisma, e as createError, n as getOperatorScope, f as getQuery, k as setHeader } from '../../../../../_/nitro.mjs';
import { readFile } from 'node:fs/promises';
import { join } from 'node:path';
import { Document, Paragraph, Table, TextRun, AlignmentType, TableRow, WidthType, TableCell, Packer, ImageRun } from 'docx';
...
const surat_get = defineEventHandler(async (event) => {
  ...
  const logoEkskul = await loadLogoImage(ekskul == null ? void 0 : ekskul.logoUrl, 90);
  ...
  setHeader(event, "Content-Disposition", `attachment; filename="surat-izin-${record.student.nis}-${tahun}${bulan}.docx"`);
  return buf;
});

export { surat_get as default };
//# sourceMappingURL=surat.get.mjs.map
