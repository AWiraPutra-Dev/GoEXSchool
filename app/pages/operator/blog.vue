...
.scope-note { display: flex; align-items: center; gap: 8px; padding: 10px 14px; background: var(--olive-bg); color: var(--olive-primary); border: 1px solid var(--olive-light); border-radius: 8px; font-size: var(--text-sm); }
