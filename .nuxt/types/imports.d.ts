...
declare global {
  ...
  // @ts-ignore
  export type { Student, Teacher, ClassItem, Ekskul, AppUser } from '../../app/stores/master-data'
  import('../../app/stores/master-data')
  // @ts-ignore
  export type { Member, Assessment, ScheduleEntry, PollOption, Poll, NewsItem, GalleryItem, AttendanceHistoryItem } from '../../app/stores/operator-data'
  import('../../app/stores/operator-data')
  // @ts-ignore
  export type { GradeItem, AttendanceRecord, Achievement, FeedPost, StudentSchedule, SiswaPoll, SiswaGallery } from '../../app/stores/siswa-data'
