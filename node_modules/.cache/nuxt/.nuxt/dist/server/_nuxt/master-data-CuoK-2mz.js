import { s as $fetch } from "../server.mjs";
...
var useMasterDataStore = defineStore("masterData", {
	...
	actions: {
		...
		async addStudent(data) {
			const s = await $fetch("/api/admin/students", {
				method: "POST",
				body: data
			});
		...
		async updateStudent(id, data) {
			const s = await $fetch(`/api/admin/students/${id}`, {
				method: "PUT",
				body: data
			});
		...
		async addTeacher(data) {
			const t = await $fetch("/api/admin/teachers", {
				method: "POST",
				body: data
			});
		...
		async updateTeacher(id, data) {
			const t = await $fetch(`/api/admin/teachers/${id}`, {
				method: "PUT",
				body: data
			});
		...
		async addClass(data) {
			const c = await $fetch("/api/admin/classes", {
				method: "POST",
				body: data
			});
			this.classes.push(c);
		...
		async updateClass(id, data) {
			const c = await $fetch(`/api/admin/classes/${id}`, {
				method: "PUT",
				body: data
			});
		...
		async addEkskul(data) {
			const e = await $fetch("/api/admin/extracurriculars", {
				method: "POST",
				body: data
			});
		...
		async updateEkskul(id, data) {
			const e = await $fetch(`/api/admin/extracurriculars/${id}`, {
				method: "PUT",
				body: data
			});
		...
		async updateUser(id, data) {
			const u = await $fetch(`/api/admin/users/${id}`, {
				method: "PUT",
				body: data
			});
...
//#endregion
export { useMasterDataStore as t };

//# sourceMappingURL=master-data-CuoK-2mz.js.map