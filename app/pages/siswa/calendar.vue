          ...
          <template v-if="d">
            ...
            <div class="cal-events">
              ...
              >
                ...
                <Icon v-if="e.source === 'schedule' && !e.izin" name="i-lucide-pencil-line" class="cal-event-edit-hint" />
              </div>
            </div>
          </template>
        </div>
...
.cal-cell { background: var(--bg-card); border: 1px solid var(--border-light); border-radius: 8px; min-height: 110px; padding: 6px; transition: border-color 0.2s; }
...
.izin-mandatory-badge { font-size: 10px; padding: 3px 10px; border-radius: 10px; background: rgba(45,106,106,0.15); color: #2D6A6A; font-weight: var(--font-semibold); white-space: nowrap; flex-shrink: 0; }
...
.error-badge { display: flex; align-items: center; gap: 8px; padding: 10px 12px; background: #fef2f2; border: 1px solid #fecaca; border-radius: 8px; font-size: var(--text-xs); color: #dc2626; }
