...
type NuxtAppInjections = 
  ...
  InjectionType<typeof import("../../app/plugins/data-sync")> &
  InjectionType<typeof import("../../app/plugins/institution-sync")> &
  InjectionType<typeof import("../../app/plugins/pinia")> &
  InjectionType<typeof import("../../app/plugins/theme.client")> &
  InjectionType<typeof import("../../app/plugins/ui.client")>

declare module '#app' {
  interface NuxtApp extends NuxtAppInjections { }

  interface NuxtAppLiterals {
    pluginName: 'nuxt:revive-payload:client' | 'nuxt:head' | 'nuxt:head' | 'nuxt:router' | 'nuxt:revive-payload:server' | 'nuxt:chunk-reload-crawler' | 'nuxt:chunk-reload' | 'nuxt:global-components' | 'nuxt:prefetch' | '@nuxt/icon' | 'pinia'
  }
}
